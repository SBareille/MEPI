...
Visualisation des données à partir du 13 mai :
...
```{r include = FALSE}
T0=1 # Décalage du point de départ 0 jours après le 13 mai (quelle date on met ?) 
